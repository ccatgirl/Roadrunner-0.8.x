...
void RoadRunner::world::BlankChunk::set_block_id(int32_t x, int32_t y, int32_t z, uint8_t block_id) {
    //do nothing
}

void RoadRunner::world::BlankChunk::set_block_meta(int32_t x, int32_t y, int32_t z, uint8_t block_meta) {
    // do nothing
}
...
void RoadRunner::world::Chunk::set_block_id(int32_t x, int32_t y, int32_t z, uint8_t block_id) {
...
void RoadRunner::world::Chunk::set_block_meta(int32_t x, int32_t y, int32_t z, uint8_t block_meta) {
